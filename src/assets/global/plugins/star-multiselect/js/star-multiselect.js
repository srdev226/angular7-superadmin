...
(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        defaults: {
            ...
            texts: {
                noItemsAvailable: 'No found.',
                selectAll: 'Select all',
                selectNone: 'Select none',
                quickDelete: '&times;',
                searchplaceholder: 'Multiselect',
                loadingData: 'Still loading data...',
                itemsSelected: '{$a} tags selected'
            },
        ...
        _renderOption: function (solOption, $optionalTargetContainer) {
            ...
            if (this.config.multiple) {
                // use checkboxes
                $inputElement = $('<input type="checkbox" class="sol-checkbox" value="1" name="test"><span></span>');
            ...
            $label = $('<label class="sol-label app-checkbox"/>')
